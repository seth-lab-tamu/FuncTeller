...
define_design_lib WORK -path ./work
  ...
  analyze -library WORK -format sverilog ./oracle.v
  elaborate oracle
date
...
report_timing -nworst 10 -max_paths 20 -nosplit -input_pins -nets -capacitance  >         oracle_time.rpt
report_area                                        > ./oracle_area.rpt
report_power -analysis_effort high                 > ./oracle_power.rpt
write -format verilog -hierarchy -output oracle_netlist.v
exit
